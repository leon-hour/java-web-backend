...
export const getEmployees = () => async (dispatch) => {
  try {
    const authToken = localStorage.getItem("jwtToken"); // Assuming the authentication token is stored in localStorage

    const res = await axios.get("http://localhost:8095/api/employees/all", {
      headers: {
